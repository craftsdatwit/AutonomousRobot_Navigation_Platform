...
while center_list > 1.5: #While robot is more than 1m away from object
    try:
        center_list = rc.sensor_center() #Get sensor value
        rc.move_straight() #move robot straight:

        while center_list <= 1.5:
    ...
    while center_list < 1.5: #While robot is less than 1m away from object
        center_list = rc.sensor_center() #Get sensor value
        #left_list = rc.sensor_left()
